...
model = pickle.load(open(r"C:\Users\SK\Machine Learning\model.pkl", "rb"))
model1= pickle.load(open(r"C:\Users\SK\Machine Learning\model1.pkl", "rb"))
...
if st.button('Predict'):
    if prediction=="spam":
        ...
        st.image(r"C:\Users\SK\Downloads\spam.png")
    else:
